...
const TOWN_HERO_PHOTO = {
  'lagos': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Lagos, Algarve' },
  'praia-da-luz': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Praia da Luz, Algarve' },
  'sagres': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Sagres, Algarve' },
  'aljezur': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Aljezur, Algarve' },
  'alvor': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Alvor, Algarve' },
  'portimao': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Portimão, Algarve' },
  'ferragudo': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Ferragudo, Algarve' },
  'lagoa': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Lagoa, Algarve' },
  'carvoeiro': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Carvoeiro, Algarve' },
  'silves': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Silves, Algarve' },
  'monchique': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Monchique, Algarve' },
  'albufeira': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Albufeira, Algarve' },
  'vilamoura': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Vilamoura, Algarve' },
  'quarteira': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Quarteira, Algarve' },
  'loule': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Loulé, Algarve' },
  'almancil': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Almancil, Algarve' },
  'faro': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Faro, Algarve' },
  'olhao': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Olhão, Algarve' },
  'sao-bras-de-alportel': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, São Brás de Alportel, Algarve' },
  'tavira': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Tavira, Algarve' },
  'castro-marim': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Castro Marim, Algarve' },
  'vila-real-de-santo-antonio': { ...TOWN_HERO, alt: 'Freshly repainted villa facade with grey shutters, Vila Real de Santo António, Algarve' },
};
