...
const TOWN_HERO_PHOTO = {
  'lagos': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Lagos, Algarve' },
  'praia-da-luz': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Praia da Luz, Algarve' },
  'sagres': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Sagres, Algarve' },
  'aljezur': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Aljezur, Algarve' },
  'alvor': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Alvor, Algarve' },
  'portimao': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Portimão, Algarve' },
  'ferragudo': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Ferragudo, Algarve' },
  'lagoa': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Lagoa, Algarve' },
  'carvoeiro': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Carvoeiro, Algarve' },
  'silves': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Silves, Algarve' },
  'monchique': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Monchique, Algarve' },
  'albufeira': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Albufeira, Algarve' },
  'vilamoura': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Vilamoura, Algarve' },
  'quarteira': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Quarteira, Algarve' },
  'loule': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Loulé, Algarve' },
  'almancil': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Almancil, Algarve' },
  'faro': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Faro, Algarve' },
  'olhao': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Olhão, Algarve' },
  'sao-bras-de-alportel': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — São Brás de Alportel, Algarve' },
  'tavira': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Tavira, Algarve' },
  'castro-marim': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Castro Marim, Algarve' },
  'vila-real-de-santo-antonio': { ...TOWN_HERO, alt: 'Brushstrokes of terracotta, ochre and dusty pink paint on canvas — Vila Real de Santo António, Algarve' },
};
